...
store_df["CompetitionOpenSinceYear"][(store_df["CompetitionDistance"] != 0) &
                                     (is_nan(store_df["CompetitionOpenSinceYear"]))] = 1900
store_df["CompetitionOpenSinceMonth"][(store_df["CompetitionDistance"] != 0) &
                                      (is_nan(store_df["CompetitionOpenSinceMonth"]))] = 1
...
# Drop "CompetitionOpenSinceYear", "CompetitionOpenSinceMonth", "Promo2",
# "Promo2SinceYear" & "Promo2SinceWeek" (not useful for prediction)
store_df.drop(["CompetitionOpenSinceYear", "CompetitionOpenSinceMonth", "Promo2",
...
avg_cust_year = training_df.groupby(["Store", "Year"]).agg(
...
submission.to_csv("predictions/linear_regression_single.csv", index=False)
