...
"""
This model follows the features from linear_regression_log.py, with the regression model set to Ridge Regression. Treating each store as an independent regression problem, loop through all stores training the model for the particular store and predicting its sales value.
...
submission.to_csv("predictions/ridge_regression_log.csv", index=False)
